...
import android.gameengine.kontrast.alarms.Alarm;
import android.gameengine.kontrast.alarms.IAlarm;
...
public abstract class GameEngine extends Activity implements SensorEventListener {
	 ...
	 * if it's one of the widgets in android.gameengine.kontrast.dashboard
	 ...
	 * 
	 * @see android.gameengine.kontrast.engine.GameEngine#initialize()
	 */
	public GameEngine() {
	 ...
	 * overwritten.
	 * 
	 * @see android.gameengine.kontrast.objects.MoveableGameObject
	 * @see android.gameengine.kontrast.objects.GameObject
	 */
	public void update() {
