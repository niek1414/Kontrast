...
public interface ICollision {
	 ...
	 * 
	 * @see android.gameengine.kontrast.objects.collisions.TileCollision
	 * @see android.gameengine.kontrast.objects.MoveableGameObject#undoMove()
	 * @see android.gameengine.kontrast.objects.MoveableGameObject#bounce(TileCollision)
	 * @see android.gameengine.kontrast.objects.MoveableGameObject#moveUpToTileSide(TileCollision)
	 */
